...
namespace AnalyseTool.App.Features
{
    ...
    internal sealed class CheckUpdate : IRevitTask
    {
        ...
        {
            return await CheckForUpdateAsync(owner: "Nikola1Davydov", repo: "AnalyzeTool");
        }

        private static async Task<UpdateInfo?> CheckForUpdateAsync(string owner, string repo)
        {
