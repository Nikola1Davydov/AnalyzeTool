...
- ⚙️Improved internal processes to make UI actions more responsive.
- ⚙️Made minor UI refinements for better clarity and consistency.
- 🆕Added a new page: Infinite Kanban, where you can view diagrams and tables in one place.
- ✏️Added parameter editing functionality.
...
- ⚙️Improved several internal processes to make UI actions more responsive.
- ⚙️Minor UI refinements for better clarity and consistency.

## [1.2.0] – 2025-11-29

- new Web-based visual interface
- new code architecture. Backend c# - Frontend JavaScript/Typescript with Vue
- add diagram
- add new page "About"
- Revit 2024 support removed (focus on newer versions)
