...
[`../analyses/mcp-surface-state.md`](../analyses/mcp-surface-state.md). Не проверено вживую:
исправления сделаны при закрытом Revit; подтверждение — следующий такой же прогон.
