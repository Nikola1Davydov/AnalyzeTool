...
| Кластер | Issue | Где |
| --- | --- | --- |
| Дефекты и протокол MCP | 83–85, 99, 101–113, 128 (97, 98, 100 закрыты 2026-09-02; 129 — команды больше нет) | [`mcp-surface-state.md`](mcp-surface-state.md), [`../concepts/long-running-calls.md`](../concepts/long-running-calls.md) |
