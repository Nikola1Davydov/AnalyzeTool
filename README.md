...
📖 **Full authoring guide:** [`ONBOARDING.md`](src/ONBOARDING.md) and the [GitHub Wiki](https://github.com/Nikola1Davydov/AnalyzeTool/wiki). Writing with AI? Paste [`LLM.md`](src/LLM.md) into Claude/ChatGPT and it writes AnalyseTool extensions for you.
